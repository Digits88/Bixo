...
return [
    ...
    */
    ...
    'aliases' => [
        ...
        'Activities'   => Lavalite\Bixo\Facades\Activities::class,
        'Filer'        => Lavalite\Bixo\Facades\Filer::class,
        'Form'         => Lavalite\Bixo\Facades\Form::class,
        'Hashids'      => Lavalite\Bixo\Facades\Hashids::class,
        'Menu'         => Lavalite\Bixo\Facades\Menu::class,
        'Role'         => Lavalite\Bixo\Facades\Role::class,
        'Settings'     => Lavalite\Bixo\Facades\Settings::class,
        'Trans'        => Lavalite\Bixo\Facades\Trans::class,
        'User'         => Lavalite\Bixo\Facades\User::class,
    ],
